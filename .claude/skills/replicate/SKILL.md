...
5. **QC 门**：
   ...
   - **每镜抽 3 帧(首/中/尾)按手册第九章清单审**:视线对镜头?轴线一致?手部畸变?
     动作强度?语气听感? —— 任一违例重生成,不许带病装配
   - 失败重试免费重发；「上游终止」多为内容审核，软化措辞重发
   - 对手戏 script 每镜标 who + eyeline(R/L/partner)，lint 会查轴线一致性

## 五、装配前：连贯性走查 + 叙事可读性

因果链走查之外,按手册第十三章过信息链:每镜标信息点、伏笔≥2次入画、
揭底与所见一致。**装配后冷读测试**:新代理仅凭帧墙+台词复述故事,
复述≠意图即返工。交付带烧字幕预览版。
